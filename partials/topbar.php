<div class="navbar-custom">
    <div class="topbar container-fluid">
        <div class="d-flex align-items-center gap-1">
            ...
            <!-- Topbar Search Form -->
            <div class="app-search d-none d-lg-block mt-2">
                <h4 class="page-title">Projects Management System MBU | ระบบบริหารจัดการโครงการ</h4>
            </div>
        </div>

        <ul class="topbar-menu d-flex align-items-center gap-3">
            <li class="dropdown d-lg-none mt-2">
            <h4 class="page-title">PROMS MBU</h4>
            ...
            <li class="dropdown">
                <a class="nav-link dropdown-toggle arrow-none nav-user" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                    ...
                    <span class="d-lg-block d-none">
                        <h5 class="my-0 fw-normal"><?php echo $_SESSION['user_firstname'], ' ', $_SESSION['user_lastname']; ?> <i class="ri-arrow-down-s-line d-none d-sm-inline-block align-middle"></i></h5>
                    </span>
                </a>
