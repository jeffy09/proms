                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title">เพิ่มโครงการแบบมีกิจกรรมย่อย</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                                    ...
                                    <form method="POST" action="process_add_new_project">
                                        <div class="row">
                                            <div class="col-4">
                                                ...
                                                <input class="form-control" type="hidden" id="project_status" name="project_status" value="0" readonly><br><br>
                                            </div>
                                            <div class="col-4">
                                        ...
                                        <div class="row">
                                            ...
                                            <input class="form-control" type="hidden" id="activity_type" name="activity_type" value="2" readonly><br>
