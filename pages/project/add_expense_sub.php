...
$query = "SELECT * FROM sub_project_requests WHERE id = :project_id";
...
$main_project_id = $project['project_id'];
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="container">
                                        ...
                                        <form action="process_add_expense_sub" method="POST" id="expenseForm">
                                            <input type="hidden" name="project_id" value="<?php echo $project_id; ?>">
                                            <input type="hidden" name="main_project_id" value="<?php echo $main_project_id; ?>">
