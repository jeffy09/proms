...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        foreach ($expenses as $expense) {
            ...
            $query = "INSERT INTO project_expense (project_id, expense_id, expense_details, unit_quantity, unit_quantity_2, unit_cost, total_cost, note)
                      VALUES (:project_id, :expense_id, :expense_details, :unit_quantity, :unit_quantity_2, :unit_cost, :total_cost, :note)";
        ...
        $query = "UPDATE project_requests SET budget_id = :budget_id, funding_source = :funding_source, used_budget = :used_budget, cost_goals_plan = :used_budget ,project_status = '2' WHERE id = :project_id";
        $stmt = $db->prepare($query);
