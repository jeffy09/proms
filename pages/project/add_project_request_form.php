                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title">เพิ่มโครงการ</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form method="POST" action="process_add_project_request">
                                        <div class="row">
                                            <div class="col-4">
                                                ...
                                                <input class="form-control" type="hidden" id="department_id" name="department_id" value="<?php echo $department_id; ?>" readonly><br><br>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-3">
                                                ...
                                                <input class="form-control" type="text" id="project_number" name="project_number" value="MBU-<?php echo $budget_info['year']; ?>-<?php echo $department_id; ?>-<?php echo date('dmHi'); ?>" readonly><br>
                                            </div>
                                            <div class="col-3">
                                                <label for="project_number">ปีงบประมาณ:</label>
                                                <input class="form-control" type="text" id="project_year" name="project_year" value="<?php echo $budget_info['year'] + 543; ?>" readonly><br>
                                            </div>
                                        </div>
                                        <label for="project_name">ชื่อโครงการ:</label>
                                        <input class="form-control" type="text" id="project_name" name="project_name" value="<?php echo $budget_info['project_name']; ?>" required readonly><br>
                                        <div class="row">
                                            ...
                                            <div class="col-3">
                                                ...
                                                <input class="form-control" type="text" id="funding_source" name="funding_source" value="<?php echo $budget_info['funding']; ?>" readonly><br>
                                            </div>
                                            <div class="col-3">
                                                <label for="allocated_budget">งบประมาณของหน่วยงานทั้งหมด:</label>
                                                <input class="form-control" type="number" step="0.01" id="allocated_budget" name="allocated_budget" value="<?php echo $budget_info['budget']; ?>" readonly><br>
                                            </div>
                                            <div class="col-3">
                                        ...
                                        <div class="row">
                                            <div class="col-4">
                                                ...
                                                <select class="form-select" id="project_type" name="project_type" required>
                                                    ...
                                                    <option value="โครงการงานประจำ">โครงการงานประจำ</option>
                                                    <option value="โครงการงานพัฒนา">โครงการงานพัฒนา</option>
                                                </select><br>
                                            </div>
                                            <div class="col-4">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <textarea class="form-control" id="impacts" name="impacts" required></textarea><br>
                                            </div>
                                            <div class="col-12">
