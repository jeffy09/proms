...
$budgets = getBudgetsDep($department_id);
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="header-title">โครงการทั้งหมด</h4>
                                ...
                                <div class="card-body">
                                    ...
                                    <table id="scroll-horizontal-datatable" class="table table-striped w-100 nowrap">
                                        ...
                                        <tbody>
                                            <?php
                                            foreach ($project_requests as $index => $request) :
                                                $status_text = ($request['project_status'] == 1) ? 'รอเพิ่มค่าใช้จ่าย' : 'รอการตรวจสอบ'; ?>
                                                <tr>
                                                    <td><?php echo $index + 1; ?></td>
                                                    <td><?php echo htmlspecialchars($request['project_year'] + 543); ?></td>
                                                    <td><?php echo htmlspecialchars($request['project_name']); ?></td>
                                                    <td><?php echo (getActivityType($request['activity_type'])); ?></td>
                                                    <td>
                                                        <?php if ($request['activity_type'] == 1) { ?>
                                                            <?php echo (getStatusText($request['project_status'])); ?>
                                                        <?php  } ?>
                                                        <?php if ($request['activity_type'] == 2) { ?>
                                                        <?php echo (getStatusText_sub($request['project_status'])); ?>
                                                        <?php  } ?>
                                                    </td>
                                                    <td>
                                                        <?php if (($request['project_status'] == 1) && ($request['activity_type'] == 1) && ($department_id != 999)) { ?>
                                                            <a href="add_expense?id=<?php echo urlencode(encrypt($request['id'])); ?>" class="btn btn-primary btn-sm">เพิ่มค่าใช้จ่าย</a>
                                                        <?php  } ?>
                                                        <?php if (($request['project_status'] == 0) && ($request['activity_type'] == 2) && ($department_id != 999)) { ?>
                                                            <a href="add_sub_project?id=<?php echo urlencode(encrypt($request['id'])); ?>" class="btn btn-primary btn-sm">เพิ่มกิจกรรมย่อย</a>
                                                        <?php  } ?>
                                                        <!-- <?php if ($budget_info['budget_status'] == 0) : ?>
                                                            <a href="add_project?id=<?php echo urlencode(encrypt($budget_info['id'])); ?>" class="btn btn-warning btn-sm">เพิ่มข้อมูล</a>
                                                        <?php endif; ?> -->
                                                        <a href="project_details?project_id=<?php echo urlencode(encrypt($request['id'])); ?>" class="btn btn-purple btn-sm">ดูรายละเอียด</a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
