                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <div class="form-group mb-2">
                                                    <label class="form-label">ค่าใช้จ่ายเดิมทั้งของโครงการ:</label>
                                                    <input type="text" class="form-control" value="<?= $total_budget ?>" readonly>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="form-group mb-2">
                                        ...
                                        <form action="process_added_expense" method="POST" id="expenseForm">
                                            <input type="hidden" name="project_id" value="<?php echo $project_id; ?>">

                                            <input type="hidden" name="budget_id" value="<?php echo $id_budget; ?>">
                                            <input type="hidden" class="form-control" id="budget_old" name="budget_old" value="<?= $total_budget ?>">
                                            <hr>
                                            ...
                                            <div class="row mt-3">
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        <label>ค่าใช้จ่ายที่เพิ่มเติม:</label>
                                                        <input type="text" class="form-control" id="totalExpense" name="total_budget" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        <label>ค่าใช้จ่ายทั้งหมดหลังเพิ่มเติม:</label>
                                                        <input type="text" class="form-control" id="totalAllExpense" name="total_all_budget" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group mt-4">
                                        ...
                                        <input type="text" class="form-control" id="modalTotalAllExpense" readonly>
                                    </div>
                                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function updateTotalExpense() {
                ...
                // ปิดการใช้งานปุ่ม 'ยืนยัน' หากไม่มีค่าใช้จ่ายหรือเกินงบ
                $('#openModalBtn').prop('disabled', totalExpense === 0 || isOverBudget);

                // อัปเดต totalAllExpense โดยบวกค่า budget_old กับ totalExpense
                var budgetOld = parseFloat($('#budget_old').val()) || 0;
                var totalAllExpense = budgetOld + totalExpense;

                // ตั้งค่าผลลัพธ์ลงในช่อง totalAllExpense
                $('#totalAllExpense').val(totalAllExpense.toFixed(2));
            }
            ...
            function updateModalSummaryTable() {
                ...
                var totalAllExpense = $('#totalAllExpense').val();
                $('#modalTotalAllExpense').val(totalAllExpense);
            }
        });
    </script>
</body>
